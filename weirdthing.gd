...
@onready var fl_leg = $Armature/leftarmIktarget
@onready var fr_leg = $Armature/rightarmIktarget

@onready var bl_leg = $Armature/leftlegIktarget
@onready var br_leg = $Armature/rightlegIktarget

func _process(delta):
	if fl_leg != null || fr_leg != null || bl_leg != null || br_leg != null:
...
func _basis_from_normal(normal: Vector3) -> Basis:
	var result = Basis()
	result.y = normal.cross(transform.basis.z)
	result.y = normal
